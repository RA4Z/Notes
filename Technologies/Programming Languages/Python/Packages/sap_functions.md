sap_functions is one module in the Python [[Packages]] PiPy library

Library with utility classes and functions to facilitate the development of SAP [[Automation]] in python.
...
Checks for existent SAP GUI instances.
