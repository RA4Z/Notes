...
Every commit in Git points to a **root tree**, which recursively references other trees (subdirectories) and blobs (file contents). This structure allows [[Git]] to reconstruct the exact state of a project for any commit
